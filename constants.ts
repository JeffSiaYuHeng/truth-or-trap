...
export const CARD_DETAILS: Record<Card, {
  ...
  [Card.IMMUNITY]: {
    image: '/images/cards/IMMUNITY_CARD.png',
  ...
  [Card.INTENSIFY]: {
    image: '/images/cards/INTENSIFY_CARD.png',
  ...
  [Card.REVERSE]: {
    image: '/images/cards/REVERSE_CARD.png',
  ...
  [Card.BATTLE]: {
    image: '/images/cards/BATTLE_CARD.png',
  ...
  [Card.STEAL]: {
    image: '/images/cards/STEAL_CARD.png',
  ...
  [Card.KING]: {
    image: '/images/cards/KING_CARD.png',
